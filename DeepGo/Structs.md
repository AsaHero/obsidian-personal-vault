...
**Пример 1 — SBO (Small Buffer Optimization).** Идея: если данные маленькие — хранить их прямо внутри структуры, а если большие — хранить указатель + capacity в том же месте памяти:
