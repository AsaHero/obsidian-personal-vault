...
> ⚠️ Важно: `recover()` работает только в рамках стека **той же горутины**, где случился `panic` — поймать панику из другой горутины нельзя, подробнее в [[Goroutines#Panic в одной горутине не убивает другую|Goroutines]].
